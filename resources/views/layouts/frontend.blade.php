...
<head>
    ...
    <title>TechBiz - IT Solution & Service HTML Template - Home Two - Slickslider</title>
                        ...
                        <div class="hero-content">
                            <div class="hero-play">
                                <a href="https://www.youtube.com/watch?v=_sI_Ps7JSEk"
                                    class="play-btn style4 popup-video"><i class="fas fa-play"></i></a>
                            ...
                            <div class="hero-btns">
                                <a href="about.html" class="vs-btn ls-hero-btn">ABOUT US<i
                                        class="far fa-arrow-right"></i></a>
        ...
        <div class="container-fluid overflow-hidden px-xxl-0">
            <div class="row vs-carousel" data-slide-show="4" data-ml-slide-show="3" data-lg-slide-show="3"
                ...
                <div class="col-xl-3">
                    <div class="project-style2">
                        <div class="project-img">
                            <img src="assets/img/gallery/gal-1-1.jpg" alt="project">
                ...
                <div class="col-xl-3">
                    <div class="project-style2">
                        <div class="project-img">
                            <img src="assets/img/gallery/gal-1-2.jpg" alt="project">
                            <div class="project-shape"></div>
                ...
                <div class="col-xl-3">
                    <div class="project-style2">
                        <div class="project-img">
                            <img src="assets/img/gallery/gal-1-3.jpg" alt="project">
                            <div class="project-shape"></div>
                ...
                <div class="col-xl-3">
                    <div class="project-style2">
                        <div class="project-img">
                            <img src="assets/img/gallery/gal-1-4.jpg" alt="project">
                            <div class="project-shape"></div>
                ...
                <div class="col-xl-3">
                    <div class="project-style2">
                        <div class="project-img">
                            <img src="assets/img/gallery/gal-1-5.jpg" alt="project">
                            <div class="project-shape"></div>
            ...
            <div class="row gx-60">
                <div class="col-xl-6 align-self-center space  wow fadeInUp" data-wow-delay="0.2s">
                    ...
                    <p class="mb-4 mt-1 pb-3 text-white">Compellingly mesh cross-platform portals through functional
                        human capital world-class architectures for orthogonal initiatives. Assertively benchmark
                        visionary quality vectors after covalent e-tailers. Intrinsicly</p>
                    <div class="row gy-30">
                        <div class="col-md-6">
